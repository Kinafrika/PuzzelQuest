...
import { RiddlePuzzle } from '../../../data/puzzleTypes';
...
export function RiddleGame({ 
  ...
  const handleSubmit = () => {
    ...
    const isCorrect = puzzle.acceptableAnswers.some(answer => 
      answer.toLowerCase() === normalizedAnswer
    );
    onAnswer(isCorrect ? puzzle.correctAnswer : userAnswer, timeSpent);
  };
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {/* Riddle Display */}
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-950 dark:to-blue-950 p-6 rounded-lg border">
              ...
              <div className="flex-1">
                ...
                {!isCorrect && (
                  <p className="text-sm mb-2">
                    The correct answer is: <strong>{puzzle.correctAnswer}</strong>
                  </p>
                )}
